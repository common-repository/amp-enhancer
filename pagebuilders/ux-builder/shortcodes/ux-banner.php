<?php
// [ux_banner]
function amp_enhancer_flatsome_ux_banner( $atts, $content = null ){
  ...
  <div class="banner <?php echo $classes; ?> ux-amp-cont" id="<?php echo $_id; ?>">
...
add_shortcode('ux_banner', 'amp_enhancer_flatsome_ux_banner');
