<?php
function amp_enhancer_ux_image( $atts, $content = null ) {
  ...
  if ( $visibility ) $classes[] = $visibility;
	...
	ob_start();
	?>
	<div class="img has-hover <?php echo $classes; ?> ux-amp-cont" id="<?php echo $_id; ?>">
		<?php echo $link_start; ?>
...
add_shortcode( 'ux_image', 'amp_enhancer_ux_image' );
